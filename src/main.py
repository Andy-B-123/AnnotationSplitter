...
#fasta_path=r"U:\\AnnotationCheckerWithStructure\\Development\\check_other_organisms\\GCF_037355615.1_Dsuz_RU_1.0_genomic.fna"
#gff_path=r"U:\\AnnotationCheckerWithStructure\\Development\\check_other_organisms\\GCF_037355615.1_Dsuz_RU_1.0_genomic.gff"
#output_folder=r"U:\\AnnotationCheckerWithStructure\\Development\\Redux4.UncharacterisedOnly"
...
def run_pipeline(fasta_path, gff_path, output_folder, database_path, mmseqs_path, threads, mmseqs_params,create_bed_file,analyse_all_genes):
    ...
    if analyse_all_genes != True:
        CDS_df_with_proteins_uncharOnly = CDS_df_with_proteins[CDS_df_with_proteins['product'].str.contains("Uncharacteri",case=False, na=False)]
        print(f"Focusing on the {len(CDS_df_with_proteins_uncharOnly)} uncharacterised genes...")
